...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf($_POST['csrf_token'] ?? '')) {
        ...
        } elseif (!is_unique_slug($slug, 'categories')) {
        ...
        if (empty($errors)) {
            ...
            ");
            $stmt->execute([
                $name, $slug, $description, $parent_id, $sort_order, $status, $meta_title ?: null, $meta_description ?: null,
            ]);
                        ...
                        <div>
                            ...
                            >
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <option value="<?= e((string)$category['id']) ?>" <?= old('parent_id') == $category['id'] ? 'selected' : '' ?>>
                                        <?= e($category['name']) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
