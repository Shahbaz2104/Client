      ...
      <section className="relative pt-48 pb-24 bg-brand-dark overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="flex items-center gap-2.5 text-xs font-semibold uppercase tracking-widest text-gray-400 mb-8">
            ...
            <span className="text-brand-accent font-bold">Business Divisions</span>
          </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-32">
          {divisions.map((division) => (
            ...
            >
              ...
              >
                <div className="relative rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-2xl glow-hover group">
                  <img
                    src={division.image}
                    alt={division.title}
              ...
              <div className="lg:col-span-5 bg-white/5 border-l border-white/10 p-8 md:p-16 relative z-10 flex flex-col justify-center">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <div>
                    ...
                    <select className="w-full bg-brand-primary border border-white/10 rounded-xl py-3.5 px-4 text-gray-300 focus:outline-none focus:border-brand-accent focus:ring-1 focus:ring-brand-accent text-xs">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-brand-accent hover:bg-[#b8e036] text-brand-dark font-extrabold py-4 rounded-xl transition-all text-xs tracking-wider uppercase mt-4"
                  >
                ...
                {formSubmitted && (
                  <div className="mt-4 p-4 bg-emerald-950/80 border border-emerald-500/30 rounded-xl text-center">
                    <p className="text-xs text-emerald-400 font-bold flex items-center justify-center gap-1.5">
                      ...
                      Brief Received. Our Corporate Officer will call back.
                    </p>
                  </div>
                )}
              </div>
