...
const divisions = [
  ...
  },
  {
    ...
    keyServices: [
      'HACCP, BRCGS & FSSC 22000 Implementation',
      'GMP & GHP Prerequisite Programs',
  ...
  },
  {
    ...
    keyServices: [
      'ISO 9001 / 14001 / 45001 / 13485 Setup',
      'ISO 17025 Laboratory Accreditation',
      'ISO 22000, BRCGS & FSSC 22000 Systems',
      'Halal Certification (PS 3733) Support'
    ],
    coreBenefits: [
  ...
  },
  {
    ...
    description: 'Developing new products and reformulating existing lines — from shelf-life improvement and packaging guidance to consumer research and full commercialization support.',
    ...
    keyServices: [
      ...
      'Shelf-Life & Stability Improvement',
        ...
        <section className="relative pt-48 pb-24 bg-brand-dark overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="max-w-3xl space-y-6">
              ...
              >
                BIOSAF Enterprises delivers scientific accuracy, quality systems engineering, and custom infrastructure protection across five specialized operational wings.
              </motion.p>
            </div>
          </div>
        </section>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                      <motion.div {...buttonTap}>
                        <a
                          ...
                          className="bg-brand-accent hover:bg-brand-accentHover text-brand-dark px-8 py-4 rounded-full font-bold transition-all text-xs tracking-wider uppercase flex items-center justify-center gap-2"
                        >
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <form className="space-y-4" onSubmit={handleFormSubmit}>
                      ...
                      <div>
                        ...
                        <select value={formData.division} onChange={(e) => setFormData({...formData, division: e.target.value})} className="w-full bg-brand-primary border border-white/10 rounded-xl py-3.5 px-4 text-gray-300 focus:outline-none focus:border-brand-accent focus:ring-1 focus:ring-brand-accent text-xs">
                          ...
                          <option>Product Innovation & Development</option>
                        </select>
                      </div>
                      <motion.button
                        type="submit"
