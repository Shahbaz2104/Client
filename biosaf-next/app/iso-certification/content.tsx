...
export default function IsoCertificationContent() {
  ...
  const standards = [
    ...
    { 
      ...
      description: 'Medical Device Quality Management Systems (MDQMS). Meet regulatory requirements and deliver safe, reliable medical devices to global markets.', 
      points: ['Design Control & Risk Management', 'Regulatory Documentation'], 
      icon: <Syringe className="text-2xl" />
    },
    { 
      title: 'BRCGS Food Safety', 
      category: 'GFSI Retailer Standard', 
      description: 'BRCGS Global Food Safety certification recognized by major UK and international retailers as a condition of supply.', 
      points: ['Site Standards & Pest Control', 'Traceability & Recall Readiness'], 
      icon: <Store className="text-2xl" />
    },
    { 
      title: 'FSSC 22000', 
      category: 'GFSI Certification', 
      description: 'FSSC 22000 scheme built on ISO 22000 plus prerequisite programs — the complete GFSI-recognized food safety certification.', 
      points: ['PRPs & Hazard Control', 'Audit Cycle Support'], 
      icon: <Factory className="text-2xl" />
    }
  ];
